...
def main():
    ...
    # Save the models
    chi2_dnn_model.save("chi2_dnn_model.keras")  # No warning
    chi2_ann_model.save("chi2_ann_model.keras")
    dnn_model.save("dnn_model.keras")
    ann_model.save("ann_model.keras")

    # At the end of main() function, before the if __name__ block:
    return chi2_scaler, full_scaler

if __name__ == "__main__":
    chi2_scaler, full_scaler = main()  # Capture the returned scalers
